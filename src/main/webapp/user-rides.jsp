...
<body>
  ...
  <tbody>
    ...
    <tr>
     	...
     	<th>${ride.getPrice() }</th>
     	<th><button type="button" class="btn btn-danger" onclick="return confirm('Are you sure?');">Delete</button>
     		<a type="button" class="btn btn-secondary" href="ride-info?id=${ride.getRideId()}">All info</a>
     	</th>
    </tr>
    </c:forEach>
  </tbody>
